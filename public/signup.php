...
<header class="header w-full max-w-[900px] fixed mx-auto bg-white py-3 px-5 rounded-lg shadow-md flex items-center justify-between left-[50%] translate-x-[-50%]">
  ...
  <a href="login.php" class="hover:text-orange-400 underline">login</a>
</header>
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" action="../includes/signup.inc.php" method="post" id="signup-form" enctype="multipart/form-data">
                ...
                <div class="flex gap-5">
                  ...
                  <button type="submit" id="signup" class="w-full uppercase tracking-wide text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign Up</button>
